...
%% Types
-type headers()      :: list({any(), any()}) | map().
-type result_ok()    :: {ok, headers(), list() | map()}.
-type result_error() :: {error, {atom(), headers()}} | {error, any()}.
